...
============================================
    ...
    场景:	ECU复位子功能参数不支持
        ...
        那么    CANBUS上有诊断会话控制否定响应，参数OriginalRequestServiceIdentifier为ECU复位，参数NegativeResponseCode为子功能不支持
    ...
    场景:	ECU复位请求安全访问拒绝
        ...
        那么    CANBUS上有诊断会话控制否定响应，参数OriginalRequestServiceIdentifier为诊断会话控制，参数NegativeResponseCode为安全访问拒绝
