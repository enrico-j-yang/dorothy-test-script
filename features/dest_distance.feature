...
============================================
    ...
    @DestTimeRemaining
    场景:	显示到达目的地剩余时间为非法值
        当      CANBUS上目的地距离值为0xF(15)h0xF(15)m
    ...
    场景:	显示下一个路口的距离为带小数的公里数
        当      CANBUS上下一个路口的距离值为10.513km
        
        而且    CANBUS上信号持续3秒
        那么    HUD显示下一个路口的距离为10.5km
