...
============================================
    ...
    场景:	清除排放相关系统诊断信息失败
        ...
        那么    CANBUS上有清除诊断信息否定响应，参数OriginalRequestServiceIdentifier为清除诊断信息，参数NegativeResponseCode为条件未满足
    ...
    场景:	清除所有组诊断信息请求报文长度错误
        ...
        那么    CANBUS上有清除诊断信息否定响应，参数OriginalRequestServiceIdentifier为清除诊断信息，参数NegativeResponseCode为报文长度错误
    ...
    场景:	清除所有组诊断信息请求请求超出范围
        ...
        那么    CANBUS上有清除诊断信息否定响应，参数OriginalRequestServiceIdentifier为ECU复位，参数NegativeResponseCode为请求超出范围