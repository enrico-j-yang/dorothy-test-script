...
功能: 当前道路名称显示
  ...
  场景:    当前道路名称数据为两帧，无连续帧，路口名称不滚动
    当      CANBUS上当前道路名称数据第1帧首帧为黄埔大
    而且    CANBUS上当前道路名称数据第2帧结束帧为道西
    而且    CANBUS上信号持续0.2秒
